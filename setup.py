...
install_requires = \
['dotenv_switch @ git+git://github.com/UMNLibraries/dotenv_switch.git@master',
 'experts_dw @ git+git://github.com/UMNLibraries/experts_dw.git@7.11.0',
 'jinja2>=2.11.3',
 'pandas',
 'pureapi @ git+git://github.com/UMNLibraries/pureapi.git@4.1.1',
 'python-daemon',
 'python-json-logger',
 'schedule']
