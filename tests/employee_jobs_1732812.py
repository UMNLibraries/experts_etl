...
entries = [
  {
    ...
    'effseq': '0',
    'position_nbr': ' ', # This is real data from ps_dwhr job!
    'jobcode': '9401',
    ...
    'status_flg': 'C',
    'job_terminated': 'Y',
    'last_date_worked': datetime.datetime(2002,6,2,0,0),
    'job_entry_dt': datetime.datetime(1994,9,16,0,0),
...
jobs = [
  {
    ...
    'start_date': datetime.datetime(1994,9,16,0,0),
    'end_date': datetime.datetime(2002,6,2,0,0),
